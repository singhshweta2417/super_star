...
class ClaimWinningTripleViewModel extends ChangeNotifier {
  final _claimWinTripleRepo = ClaimWinningTripleRepository();
  ...
  Future<void> claimWinningTripleApi(context) async {
    setLoading(true);
    UserViewModel userViewModel = UserViewModel();
    String? userId = await userViewModel.getUser();
    Map data = {"user_id": userId};
    _claimWinTripleRepo
        .claimWinningTripleApi(data)
        .then((value) {
