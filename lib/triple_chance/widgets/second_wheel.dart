...
class SecondWheelSpin extends StatefulWidget {
  ...
  @override
  State<SecondWheelSpin> createState() => _SecondWheelSpinState();
}

class _SecondWheelSpinState extends State<SecondWheelSpin>
  ...
  void initState() {
    super.initState();
    widget.controller.secondStartWheel = startWheel;
    widget.controller.secondStopWheel = stopWheel;
