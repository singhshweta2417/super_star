...
class SpinWheel extends StatefulWidget {
  ...
  @override
  State<SpinWheel> createState() => _BlueWheelSpinState();
}
...
class _BlueWheelSpinState extends State<SpinWheel>
  ...
  void initState() {
    super.initState();
    widget.controller.spinStartWheel = startWheel;
    widget.controller.spinStopWheel = stopWheel;
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      final lastIndex =
          Provider.of<SpinResultViewModel>(
            context,
            listen: false,
          ).spinResultList.first.winIndex;
