...
class Lucky12SecondWheel extends StatefulWidget {
  ...
  @override
  State<Lucky12SecondWheel> createState() => _Lucky12SecondWheelState();
}
...
class _Lucky12SecondWheelState extends State<Lucky12SecondWheel>
  ...
  void initState() {
    super.initState();
    widget.controller.lucky12secondStartWheel = startWheel;
    widget.controller.lucky12secondStopWheel = stopWheel;
